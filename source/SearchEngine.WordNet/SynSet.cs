...
namespace SearchEngine.WordNet
{
    ...
    public class SynSet
    {
        ...
        private Dictionary<WordNetEngine.SynSetRelation, Dictionary<SynSet, Dictionary<int, Set<int>>>>
            _lexicalRelations;
        ...
        internal void Instantiate(string definition, Dictionary<string, SynSet> idSynset)
        {
            ...
            _lexicalRelations =
                new Dictionary<WordNetEngine.SynSetRelation, Dictionary<SynSet, Dictionary<int, Set<int>>>>();
        ...
        public SynSet GetClosestMutuallyReachableSynset(SynSet synset,
            IEnumerable<WordNetEngine.SynSetRelation> relations)
        {
            // avoid cycles
            Set<SynSet> synsetsEncountered = new Set<SynSet>();
            synsetsEncountered.Add(this);
        ...
        {
            Dictionary<WordNetEngine.SynSetRelation, Dictionary<string, Set<string>>> relatedWords =
                new Dictionary<WordNetEngine.SynSetRelation, Dictionary<string, Set<string>>>();
