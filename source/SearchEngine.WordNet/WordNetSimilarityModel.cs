...
namespace SearchEngine.WordNet
{
    public class WordNetSimilarityModel
    {
        ...
        public float GetSimilarity(string string1, WordNetEngine.POS pos1, string string2, WordNetEngine.POS pos2,
            Strategy strategy, params WordNetEngine.SynSetRelation[] relations)
        {
            float similarity = 0;
        ...
        /// <returns>Similarity</returns>
        public float GetSimilarity(SynSet synset1, SynSet synset2, Strategy strategy,
            params WordNetEngine.SynSetRelation[] relations)
        {
            if (relations == null)
                relations =
                    Enum.GetValues(typeof(WordNetEngine.SynSetRelation)).Cast<WordNetEngine.SynSetRelation>().ToArray();
